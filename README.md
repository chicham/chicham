...
- [fix: stop CI from installing the eval/inference stack for test runs](https://github.com/artefactory/artefactual/pull/293) on [artefactory/artefactual](https://github.com/artefactory/artefactual) (5 days ago)
